#El codigo lee los sensores y gps y envia en comunicacion serial una lista con los valores de los sensores y luego los valores del gps incluyendo dia y fecha
...
//Imprimimos los datos de cada cosa
  ...
  Serial.println();
  for(int i = 0; i < 6; i++){
    String envio = String(datos_gps[i],9);
    for (int j = 0; j < 10; j++){
    Serial.write(envio[j]);
    }
    Serial.println();
